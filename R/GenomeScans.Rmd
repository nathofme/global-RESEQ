...
```{r low diversity in native range}
...
```
Number of SNPs have below-average diversity in the native range.
Of these SNPs, how many have higher-than average pi in the invasive range (AU or US)? 

```{r higher div in AU than in native UK}
...
```{r higher div in US than in native UK}
...
```{r intersections between AU and US novel pi}
...
```{r any shared novel div outliers}
